...
function isModelError(error) {
    ...
    return msg.toLowerCase().includes('model') || msg.toLowerCase().includes('decommission');
}
function fallbackResult(reasoning) {
    return {
        category: 'Others',
        confidence: 0.5,
        mode: 'ai',
...
async function POST(req) {
    try {
        let user = null;
        try {
            user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$requestAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(req);
        } catch  {
            user = null;
        }
        ...
        if (!user) {
            if (!guestId) {
                guestId = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f0792f4._.js.map