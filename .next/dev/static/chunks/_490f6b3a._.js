...
"[project]/components/AuthDialog.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthDialog({ open, onOpenChange, onAuthed, title = 'Sign in to continue', defaultMode = 'login' }) {
    _s();
    const [mode, setMode] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](defaultMode);
...
_s(AuthDialog, "ORh32FQJ8uM82QOvPHsbDxyXs8U=");
_c = AuthDialog;
var _c;
...
function AppHeader() {
    ...
    const [authOpen, setAuthOpen] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    const refreshMe = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "AppHeader.useCallback[refreshMe]": async ()=>{
            try {
                setMe(await fetchMe());
            } catch  {
                setMe({
    ...
    }["AppHeader.useCallback[refreshMe]"], []);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "AppHeader.useEffect": ()=>{
            void refreshMe();
        }
...
_s(AppHeader, "sg3an39W/ATzfUB4i63my9y9Kzk=", false, function() {
    return [
...
//# sourceMappingURL=_490f6b3a._.js.map